...
<% 
	...
	String query = "Select * from project.Reservations where status = '" + current + "' group by customer;";
...
<%
	...
	PreparedStatement psmt_orig = con.prepareStatement("SELECT first_name FROM project.User WHERE username = ?");
	psmt_orig.setString(1,rs.getString("customer"));
